...
const PROJECTS = [
  ...
  },
  {
    ...
    scenario: "Having developed standalone diagnostic tools, I realized the need for a centralized governance system. This project bridges the gap between 'detecting a fault' and 'managing the resolution process' by implementing a custom ITSM workflow.",
    problem:  "",
    solution: "",
    result:   "TBD",
    active:   false,
